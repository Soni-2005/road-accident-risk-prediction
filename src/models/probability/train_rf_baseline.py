...
def main():
    print("=" * 72)
    print("PHASE 10.2 — PROBABILITY MODEL (RANDOM FOREST)")
    ...
    # -------------------------------------------------
    # Train / validation split (same as Phase 10.1)
    # -------------------------------------------------
    ...
    # -------------------------------------------------
    print("\n[3] Building preprocessing + Random Forest pipeline...")
    ...
    # Save report
    # -------------------------------------------------
    report_path = REPORT_DIR / "rf_baseline_metrics.txt"
    ...
    # Save model
    # -------------------------------------------------
    model_path = MODEL_DIR / "rf_baseline.pkl"
